...
4. **Explain *why*, briefly.** A one-line physical or convention-based justification per finding is enough — don't lecture.
...
7. **End with a one-line verdict**: *ready to merge*, *ready after blockers fixed*, or *needs rework*.
