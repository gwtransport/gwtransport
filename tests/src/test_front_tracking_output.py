...
class TestMassBalanceFunctions:
    ...
    def test_compute_cumulative_inlet_mass_constant_concentration(self):
        ...
        mass = compute_cumulative_inlet_mass(t, cin.to_numpy(), flow.to_numpy(), tedges_days=tedges)
    ...
    def test_compute_cumulative_outlet_mass_basic(self):
        ...
        mass = compute_cumulative_outlet_mass(t, v_outlet, waves, sorption, flow.to_numpy(), tedges_days=tedges)
    ...
    def test_mass_balance_conservation(self):
        ...
        mass_inlet = compute_cumulative_inlet_mass(t, cin.to_numpy(), flow_series.to_numpy(), tedges_days=tedges)
        mass_outlet = compute_cumulative_outlet_mass(
            t, v_outlet, waves, sorption, flow_series.to_numpy(), tedges_days=tedges
        )
