...
class TestMassBalanceFunctions:
    ...
    def test_compute_cumulative_inlet_mass_constant_concentration(self):
        ...
        mass = compute_cumulative_inlet_mass(t, cin.values, flow.values, tedges_days=tedges)
    ...
    def test_compute_cumulative_outlet_mass_basic(self):
        ...
        mass = compute_cumulative_outlet_mass(t, v_outlet, waves, sorption, flow.values, tedges_days=tedges)
