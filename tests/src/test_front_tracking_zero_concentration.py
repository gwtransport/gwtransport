...
class TestInletWaveCreationZeroConcentration:
    ...
    def test_nonzero_to_nonzero_creates_rarefaction_for_favorable(self):
...
class TestStepInputPlateau:
    ...
    def test_step_input_favorable_sorption_plateau(self):
        """
    ...
    def test_pulse_input_favorable_sorption(self):
